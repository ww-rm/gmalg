...
class TestSM2(unittest.TestCase):
    ...
    def test_sign1(self):
        ecdlp = gmalg.core.ECDLP(
            gmalg.core.EllipticCurve(0x8542D69E_4C044F18_E8B92435_BF6FF7DE_45728391_5C45517D_722EDB8B_08F1DFC3,
    ...
    def test_encrypt1(self):
        ecdlp = gmalg.core.ECDLP(
            gmalg.core.EllipticCurve(0xBDB6F4FE_3E8B1D9E_0DA8C0D4_6F4C318C_EFE4AFE3_B6B8551F,
