...
class SM9Core(SMCoreBase):
    ...
    def generate_mpk_sign(self, msk_s: int) -> Ec.EcPoint2:
        ...
        Args:
            msk_s: Master secret key for sign.
    ...
    def generate_sk_sign(self, hid_s: bytes, msk_s: int, uid: bytes) -> Ec.EcPoint:
        ...
        Args:
            hid_s: Sign function identity byte.
            msk_s: Master secret key for sign.
            uid: User ID.
    ...
    def generate_sk_encrypt(self, hid_e: bytes, msk_e: int, uid: bytes) -> Ec.EcPoint2:
        ...
        Args:
            hid_e: Encrypt function identity byte.
            msk_e: Master secret key for encrypt.
            uid: User ID.
    ...
    def sign(self, message: bytes, mpk_s: Ec.EcPoint2, sk_s: Ec.EcPoint) -> Tuple[int, Ec.EcPoint]:
        ...
        Args:
            ...
            mpk_s: Master public key for sign.
            sk_s: User secret key for sign.
    ...
    def begin_key_exchange(self, hid_e: bytes, mpk_e: Ec.EcPoint, uid: bytes) -> Tuple[int, Ec.EcPoint]:
        ...
        Args:
            hid_e: Encryption identity byte.
            mpk_e: Master public key for encryption.
    ...
    def get_secret_data(self, mpk_e: Ec.EcPoint, r: int, R: Ec.EcPoint, sk_e: Ec.EcPoint2) -> Tuple[Fp.Fp12Ele, Fp.Fp12Ele, Fp.Fp12Ele]:
        ...
        Args:
            mpk_e: Master public key for encryption.
            r: Random number generated by `begin_key_exchange`.
            R: Random point from another user.
            sk_e: Secret key for encryption.
    ...
    def generate_skey(self, klen: int, g1: Fp.Fp12Ele, g2: Fp.Fp12Ele, g3: Fp.Fp12Ele,
        ...
        Args:
            ...
            g1: g1 from `get_secret_data`.
            g2: g2 from `get_secret_data`.
            g3: g3 from `get_secret_data`.

            uid_init: User ID bytes of initiator.
            R_init: Random point of initiator.

            uid_resp: User ID bytes of responder.
            R_resp: Random point of responder.
    ...
    def encapsulate(self, hid_e: bytes, mpk_e: Ec.EcPoint, klen: int, uid: bytes) -> Tuple[bytes, Ec.EcPoint]:
        ...
        Args:
            hid_e: Encryption identity byte.
            mpk_e: Master public key for encryption.
            klen: Key length in bytes to encapsulate.
            uid: ID of another user.
    ...
    def decapsulate(self, C: Ec.EcPoint, klen: int, sk_e: Ec.EcPoint2, uid: bytes) -> bytes:
        ...
        Args:
            C: Encapsulated cipher.
            klen: Key length in bytes to encapsulate.
            sk_e: Secret key for encrypt.
            uid: User ID.
    ...
    def encrypt(self, hid_e: bytes, mpk_e: Ec.EcPoint, plain: bytes, uid: bytes, mac_klen: int) -> Tuple[Ec.EcPoint, bytes, bytes]:
        ...
        Args:
            ...
            plain: Plain data.
            uid: ID of another user.
            mac_klen: MAC key length in bytes.
...
class SM9KGC:
    ...
    def __init__(self, hid_s: bytes = None, msk_s: bytes = None, mpk_s: bytes = None,
        ...
        Args:
            hid_s: Single byte for sign key generation.
            msk_s: Master secret key for sign.
            mpk_s: Master public key for sign.

            hid_e: Single byte for encrypt key generation.
            msk_e: Master secret key for encrypt.
...
class SM9:
    ...
    def __init__(self, hid_s: bytes = None, mpk_s: bytes = None, sk_s: bytes = None,
        ...
        Args:
            ...
            hid_e: Single byte for encrypt key generation.
            mpk_e: Master public key for encrypt.
            sk_e: User secret key for encrypt.
    ...
    def end_key_exchange(self, klen: int, r: int, R: bytes, uid: bytes, R2: bytes, mode: KEYXCHG_MODE) -> bytes:
        ...
        Args:
            ...
            r: Random number of self.
            R: Random point of self.
            uid: ID of another user.
            R2: Random point of another user.
